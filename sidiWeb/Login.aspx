...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <!-- Logo Section -->
        <div class="col-md-6 d-flex align-items-center justify-content-center p-0" style="overflow: hidden; min-height: 100vh;">
        ...
        <form id="form2" runat="server">
            ...
            <div class="mb-4 mt-0">
                <div class="text-start mt-0 mb-1">
                    <h1 class="display-5 fw-bold text-white mt-0 pt-0" style="margin-top: 0 !important; line-height: 1;">
                        INTRANET IDI
                    </h1>
                </div> <br />
    ...
    <div class="mb-2 fw-bold">Encuéntranos en:</div> <br />
