                    ...
                    <div class="col-lg-5 mb-4">
                        <div class="p-3 border rounded shadow-sm bg-white h-100">
                            ...
                            <div class="table-responsive" style="max-height: 350px;">
                                <asp:GridView ID="gvAsistencias" runat="server" CssClass="table table-sm table-hover" 
                    ...
                    <div class="col-lg-7 mb-4">
                        <div class="p-3 border rounded shadow-sm bg-white h-100">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <asp:DropDownList ID="ddlTipoNota" runat="server" AutoPostBack="true" 
                                    OnSelectedIndexChanged="ddlTipoNota_SelectedIndexChanged" 
                                    CssClass="form-select form-select-sm w-auto shadow-sm">
                                </asp:DropDownList>
                            </div>
                            
                            <div class="table-responsive">
                                <asp:GridView ID="gvPromedios" runat="server" CssClass="table table-sm table-bordered text-center" 
                                    OnRowDataBound="gvPromedios_RowDataBound">
                                    <HeaderStyle CssClass="bg-primary text-white small" />
                                </asp:GridView>

                                <asp:GridView ID="gvNotas" runat="server" CssClass="table table-sm table-hover" 
